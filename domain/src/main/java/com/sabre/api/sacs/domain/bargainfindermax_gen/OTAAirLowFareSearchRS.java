...
public class OTAAirLowFareSearchRS {
    ...
    private com.sabre.api.sacs.domain.bargainfindermax_gen.Success Success;
    @JsonProperty("Warnings")
    private com.sabre.api.sacs.domain.bargainfindermax_gen.Warnings Warnings;
    @JsonProperty("PricedItineraries")
    private com.sabre.api.sacs.domain.bargainfindermax_gen.PricedItineraries PricedItineraries;
    @JsonIgnore
     ...
     */
    @JsonProperty("Success")
    public com.sabre.api.sacs.domain.bargainfindermax_gen.Success getSuccess() {
        return Success;
    }
     ...
     */
    @JsonProperty("Success")
    public void setSuccess(com.sabre.api.sacs.domain.bargainfindermax_gen.Success Success) {
        this.Success = Success;
    }

    public OTAAirLowFareSearchRS withSuccess(com.sabre.api.sacs.domain.bargainfindermax_gen.Success Success) {
        this.Success = Success;
        return this;
    }
     ...
     */
    @JsonProperty("Warnings")
    public com.sabre.api.sacs.domain.bargainfindermax_gen.Warnings getWarnings() {
        return Warnings;
    }
     ...
     */
    @JsonProperty("Warnings")
    public void setWarnings(com.sabre.api.sacs.domain.bargainfindermax_gen.Warnings Warnings) {
        this.Warnings = Warnings;
    }

    public OTAAirLowFareSearchRS withWarnings(com.sabre.api.sacs.domain.bargainfindermax_gen.Warnings Warnings) {
        this.Warnings = Warnings;
        return this;
    }
     ...
     */
    @JsonProperty("PricedItineraries")
    public com.sabre.api.sacs.domain.bargainfindermax_gen.PricedItineraries getPricedItineraries() {
     ...
     */
    @JsonProperty("PricedItineraries")
    public void setPricedItineraries(com.sabre.api.sacs.domain.bargainfindermax_gen.PricedItineraries PricedItineraries) {
        this.PricedItineraries = PricedItineraries;
    }

    public OTAAirLowFareSearchRS withPricedItineraries(com.sabre.api.sacs.domain.bargainfindermax_gen.PricedItineraries PricedItineraries) {
        this.PricedItineraries = PricedItineraries;
        return this;
    }
